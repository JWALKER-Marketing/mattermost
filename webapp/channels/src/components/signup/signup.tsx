...
import useCWSAvailabilityCheck, {
    CSWAvailabilityCheckTypes,
} from "components/common/hooks/useCWSAvailabilityCheck";
...
const Signup = ({ onCustomizeHeader }: SignupProps) => {
    ...
    const [subscribeToSecurityNewsletter, setSubscribeToSecurityNewsletter] =
        useState(false);
    ...
    const subscribeToSecurityNewsletterFunc = () => {
        try {
            Client4.subscribeToNewsletter({
                email,
                subscribed_content: "security_newsletter",
            });
        } catch (error) {
    ...
    const isUserValid = () => {
        ...
        // Add first/last name validation
        if (!firstName.trim()) {
            setFirstNameError(
                formatMessage({
        ...
        if (cwsAvailability === CSWAvailabilityCheckTypes.Available) {
            return (
                <CheckInput
                    ...
                    name="newsletter"
                    onChange={() =>
                        setSubscribeToSecurityNewsletter(
                            !subscribeToSecurityNewsletter
                        )
                    }
                    text={formatMessage(
                        {
                            ...
                            defaultMessage:
                                "<span>I would like to receive Mattermost security updates via newsletter.</span> By subscribing, I consent to receive emails from Mattermost with product updates, promotions, and company news. I have read the <a>Privacy Policy</a> and understand that I can <aa>unsubscribe</aa> at any time",
                        },
                        {
                            a: (
                                chunks: React.ReactNode | React.ReactNodeArray
                            ) => (
                                <ExternalLink
                            ...
                            aa: (
                                ...
                                <ExternalLink
                                    location="signup-newsletter-checkmark"
                                    href={
                                        HostedCustomerLinks.NEWSLETTER_UNSUBSCRIBE_LINK
                                    }
                                >
                                    {chunks}
                                </ExternalLink>
        ...
        return (
            <div className="newsletter">
                ...
                <span className="link">
                    {formatMessage(
                        {
                            id: "newsletter_optin.desc",
                            defaultMessage: "Sign up at <a>{link}</a>.",
                        },
                        {
                            ...
                            {enableSignUpWithEmail && (
                                <div className="signup-body-card-form">
                                    ...
                                    <Input
                                        ref={firstNameInput}
                                        name="firstName"
                                        className="signup-body-card-form-first-name-input"
                                        type="text"
                                        inputSize={SIZE.LARGE}
                                        value={firstName}
                                    ...
                                    <Input
                                        ref={lastNameInput}
                                        name="lastName"
                                        className="signup-body-card-form-last-name-input"
                                        type="text"
                                        inputSize={SIZE.LARGE}
                                        value={lastName}
